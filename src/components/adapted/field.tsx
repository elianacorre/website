...
const fieldVariants = cva("group/field flex w-full gap-3 data-[invalid=true]:text-destructive-foreground", {
  variants: {
    orientation: {
...
function FieldError({
  ...
  return (
    <div className={cn("font-normal text-destructive-foreground text-sm", className)} data-slot="field-error" role="alert" {...props}>
      {content}
    </div>
  );
}
