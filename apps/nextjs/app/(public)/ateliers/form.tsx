...
import { SubscribeButton } from "@ec/ui/components/web/button-subscribe";
import { CheckIcon, ChevronRightIcon } from "lucide-react";
import { useForm } from "react-hook-form";
// import { zodResolver } from "@hookform/resolvers/zod";

// ROOT ************************************************************************************************************************************
export function WorkshopsForm({ className }: WorkshopsFormProps) {
	const form = useForm({
		mode: "onTouched",
...
export type WorkshopsFormProps = { className?: string };
