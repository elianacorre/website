...
import { Command, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList, CommandSeparator } from "@ec/ui/components/command";
...
import { type ComponentProps, type ComponentType, type KeyboardEvent, useState } from "react";
 ...
 */
export interface MultiSelectProps extends ComponentProps<"button">, VariantProps<typeof multiSelectVariants> {
	/**
