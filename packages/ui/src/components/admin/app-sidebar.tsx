...
// ROOT ************************************************************************************************************************************
export function AppSidebar({ logo, navs, ...props }: AppSidebarProps) {
	return (
...
export type AppSidebarProps = ComponentProps<typeof Sidebar> & { logo: ReactNode; navs: ReactNode };
